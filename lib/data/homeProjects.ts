...
export const homeProjectsData: Record<ProjectTabId, ProjectTabContent> = {
  product: {
    ...
    alt: "Central Repository System — live college management platform by Abhinav Jain abnjain",
  },
  engineering: {
    description:
    ...
    alt: "Chess game — live web application by Abhinav Jain abnjain",
  },
  branding: {
    description:
    ...
    alt: "Shree Ram Tour and Travels — live client website by Abhinav Jain abnjain",
  },
  concepts: {
    description:
    ...
    alt: "VidhyaVardhani education platform by Abhinav Jain abnjain",
  },
  selected: {
    description:
    ...
    alt: "Abhinav Jain (abnjain) portfolio — selected work showcase",
  },
};
